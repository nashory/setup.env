...
## Tmux version upgrade   

~~~
https://gist.github.com/fikovnik/c64bd5f68701e8ce698afa58bdfb1d77
~~~


## InstallationAutomatic Installation by shellscript

```bash
git clone --recursive https://github.com/nashory/tmux-config.git
...
```bash
git clone --recursive https://github.com/nashory/tmux-config.git ~/.tmux
```
